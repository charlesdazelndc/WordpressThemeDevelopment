<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'InteriorDesin Options', 'redux-framework-demo' ),
        'page_title'           => __( 'InteriorDesin Options', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'General Fields', 'redux-framework-demo' ),
        'id'               => 'general',
        'desc'             => __( 'These are interiordesign theme fields!', 'redux-framework-demo' ),
        ...
        'fields'            =>array(
             array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Uploads Logo', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( ' Logo Will Be png Format And size 180x70', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your Webdite Logo Here.', 'redux-framework-demo' ),
                'default'  => array( 'url' => 'http://localhost/creative_theme/wp-content/uploads/2020/08/logo.png' ),
               ),
              ...
              array(
               ...
               'placeholder' => 'https://www.facebook.com/charles.dazel',
            ),
               array(
                'id'          => 'ld_link',
                'type'        => 'text',
                'title'       => __( 'Linkden Link', 'redux-framework-demo' ),
                'placeholder' => 'https://www.linkden.com/charles.dazel',
            ),
               array(
                'id'          => 'tw_link',
                'type'        => 'text',
                'title'       => __( 'Twitter Link', 'redux-framework-demo' ),
                'placeholder' => 'https://www.twitter.com/charles.dazel',
            ),
                array(
                'id'          => 'gl_link',
                'type'        => 'text',
                'title'       => __( 'Google Link', 'redux-framework-demo' ),
                'placeholder' => 'https://www.google.com/charles.dazel',
            )
...
// Banner Section
     Redux::setSection( $opt_name, array(
        ...
        'id'               => 'banner',
        'desc'             => __( 'These are interiordesign Banner fields!', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-film',
        'fields'            =>array(
             array(
     ...
     // service Section
     Redux::setSection( $opt_name, array(
        'title'            => __( 'Services Fields', 'redux-framework-demo' ),
        'id'               => 'services',
        'desc'             => __( 'These are interiordesign First Service field', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        ...
        'fields'            =>array(
             array(
                'id'            => 'service_one_head',
                'type'          => 'text',
                'title'         => __( 'Service Section 1 Headline', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Service 1 Headline', 'redux-framework-demo' ),
                 'placeholder' => 'Awesome place & what improves explore radiance.',
        ...
        array(
                'id'            => 'service_two_head',
                'type'          => 'text',
                'title'         => __( 'Service Section 2 Headline', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Service Heading 2', 'redux-framework-demo' ),
                'placeholder'   => 'Awesome place & what improves explore radiance.',
         ...
         array(
                'id'            => 'service_two_desc',
                'type'          => 'textarea',
                'title'         => __( 'Service Section 2 Description', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Service Description', 'redux-framework-demo' ),
                 'placeholder'  => '',
...
// fluid section
      Redux::setSection( $opt_name, array(
        'title'            => __( 'Fluid Fields', 'redux-framework-demo' ),
        'id'               => 'fluid',
        'desc'             => __( 'These are interiordesign Fluid field', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-cloud-alt',
        'fields'            =>array(
             array
            (
                'id'            => 'fluid_one_head',
                'type'          => 'text',
                'title'         => __( 'Fluid Headline', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Fluid Headline', 'redux-framework-demo' ),
                 'placeholder' => 'Home design made easy',
            ),
            ...
            (
                'id'            => 'fluid_desc',
                'type'          => 'textarea',
                'title'         => __( 'Fluid Description', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Fluid Description', 'redux-framework-demo' ),
            ),
        ...
        array(
                'id'            => 'fluid_footer_headline',
                'type'          => 'text',
                'title'         => __( 'Fluid Footer Headline', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Fluid  Footer Heading', 'redux-framework-demo' ),
                'placeholder'   => 'Design your home, right here at Stella Orr',
            ),

         array(
                'id'            => 'fluid_link_text',
                'type'          => 'text',
                'title'         => __( 'Fluid Link Text', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Fluid  Link Text', 'redux-framework-demo' ),
          ...
          array(
                'id'            => 'fluid_video_icon',
                'type'          => 'text',
                'title'         => __( 'Fluid Video Icon', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Fluid  Video Icon', 'redux-framework-demo' ),
                'placeholder'   => 'flaticon-play-button',
            ),
          ...
          array
            (
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Uploads Fluid Background Image', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( ' Fluid Background Image Will Be png Format And size 845x580', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your  Fluid Background Image.', 'redux-framework-demo' ),
 ...
 // -> START Works Fields
       ...
       Redux::setSection( $opt_name, array(
        'title'            => __( 'Works Fields', 'redux-framework-demo' ),
        'id'               => 'work',
        ...
        array
            (
                'id'            => 'work_headline',
                'type'          => 'text',
                'title'         => __( 'Work Headline'),
                'subtitle'      => __( 'Enter Work Headline' ),
 ...
 // -> START Works Fields
       ...
       Redux::setSection( $opt_name, array(
        'title'            => __( 'News Fields', 'redux-framework-demo' ),
        'id'               => 'news',
        'desc'             => __( 'News Fields Is Here!', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        ...
        array
            ...
            (
                'id'            => 'news_subheadline',
                'type'          => 'text',
                'title'         => __( 'News Sub Title'),
                'subtitle'      => __( 'Enter News Sub Headline' ),
       ...
       Redux::setSection( $opt_name, array(
        ...
        'id'               => 'contact',
        'desc'             => __( 'Contact Fields Is Here!', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-inbox',
        'fields'             => array(
        ...
        array
            (
                'id'            => 'contact_headline',
                'type'          => 'text',
                'title'         => __( 'Contact Headline'),
                'subtitle'      => __( 'Enter Contact Headline' ),
            ...
            (
                ...
                'type'          => 'text',
                'title'         => __( 'Contact Sub Title'),
                'subtitle'      => __( 'Enter Contact Sub Headline' ),
                
            ),
            array(
                'id'            => 'contact_link_text',
                'type'          => 'text',
                'title'         => __( 'Contact Link Text', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Contact  Link Text', 'redux-framework-demo' ),
            ...
            (
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Uploads Contact Background Image', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( ' Contact Background Image Will Be png Format And size 1898x1311', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your  Contact Background Image.', 'redux-framework-demo' ),
        ...
        // -> START Customers Fields

       Redux::setSection( $opt_name, array(
        'title'            => __( 'Customers Fields', 'redux-framework-demo' ),
        'id'               => 'customer',
        'desc'             => __( 'customer Fields Is Here!', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-child',
        'fields'             => array(
        ...
        array
            (
                'id'            => 'customer_headline',
                'type'          => 'text',
                'title'         => __( 'Customer Headline'),
                'subtitle'      => __( 'Enter Customer Headline' ),
                
            ),

            array
            (
                'id'            => 'customer_subheadline',
                'type'          => 'text',
                'title'         => __( 'Customer Sub Title'),
                'subtitle'      => __( 'Enter Customer Sub Headline' ),
     ...
     Redux::setSection( $opt_name, array(
        'title'            => __( 'About-us Fields', 'redux-framework-demo' ),
        'id'               => 'about-us',
        'desc'             => __( 'About-us Fields Is Here!', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-book',
        'fields'             => array(
        ...
        array
            (
                'id'            => 'breadcup-name',
                'type'          => 'text',
                'title'         => __( 'Breadcump Name'),
                'subtitle'      => __( 'Enter Breadcump Name' ),
            ...
            (
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'About-us Backgorund Image', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'About-us Backgorund ImageImage Will Be png Format And size 1898x1311', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your About-us Backgorund Image.', 'redux-framework-demo' ),
            ),
        array
            (
                ...
                'type'          => 'text',
                'title'         => __( 'Headline'),
                'subtitle'      => __( 'Enter About-us Headline' ),
                
            ),

            array
            (
                'id'            => 'about-us-subheadline',
                'type'          => 'text',
                'title'         => __( 'Sub Title'),
                'subtitle'      => __( 'Enter About-us Sub Headline' ),
            ...
            array
            (
                'id'       => 'stoty-interior-bg-img',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Story Image', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Story Image Will Be png Format And size 1898x1311', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your Story Image.', 'redux-framework-demo' ),
            ),
             array
            (
                'id'       => 'about-us-interior-bg-img',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Interior Design Image', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Interior Design Background Image Will Be png Format And size 1898x1311', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your Interior Design Background Image.', 'redux-framework-demo' ),
            ),
             array
            (
                'id'            => 'about-us-interior-headline',
                'type'          => 'text',
                'title'         => __( 'Interio Sub Title'),
                'subtitle'      => __( 'Enter About-us Interio Headline' ),
                
            ),

            array(
                'id'            => 'about-us-interior-des',
                'type'          => 'textarea',
                'title'         => __( 'Interior Description', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter About-us Interior Description', 'redux-framework-demo' ),
              ...
              array
            (
                'id'            => 'about-us-interior-headline-two',
                'type'          => 'text',
                'title'         => __( 'Interio Dream Title'),
                'subtitle'      => __( 'Enter About-us Interio Headline' ),
              ...
              array
            (
                'id'            => 'about-us-interior-headline-dream',
                'type'          => 'text',
                'title'         => __( 'Interio Dream Sub Title'),
                'subtitle'      => __( 'Enter About-us Interio Headline' ),
            ...
            (
                ...
                'type'          => 'text',
                'title'         => __( 'Our Team'),
                'subtitle'      => __( 'Enter Our Team text' ),
            ...
            (
                'id'            => 'our-team-des',
                'type'          => 'text',
                'title'         => __( 'Interio Dream Description'),
                'subtitle'      => __( 'Enter About-us Dream Text' ),
            ...
            (
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Mission Image', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Mission  Background Image Will Be png Format And size 1898x1311', 'redux-framework-demo' ),
                'subtitle' => __( ' Uploads Your mission Image.', 'redux-framework-demo' ),
            ),
            ...
            (
                'id'            => 'compy-mission',
                'type'          => 'text',
                'title'         => __( 'Company Mission Heading'),
                'subtitle'      => __( 'Enter Company Mission Heading' ),
                
            ),
                array
            (
                'id'            => 'compy-mission-subheading',
                'type'          => 'text',
                'title'         => __( 'Company Mission SubHeading'),
                'subtitle'      => __( 'Company Mission SubHeading' ),
                
            ),


            array(
                'id'            => 'compy-mission-des',
                'type'          => 'textarea',
                'title'         => __( 'Company Mission Description', 'redux-framework-demo' ),
                'subtitle'      => __( 'Enter Company Mission Description', 'redux-framework-demo' ),

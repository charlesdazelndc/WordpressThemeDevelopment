        ...
        public function render () {
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    $placeholder = ( isset ( $this->field[ 'placeholder' ][ 'button_tex' ] ) ) ? esc_attr ( $this->field[ 'placeholder' ][ 'button_tex' ] ) : __ ( 'Add Button Text ', 'redux-framework' );
                    echo '<li><input type="' . $title_type . '" id="' . $this->field[ 'id' ] . '-button_tex_' . $x . '" name="' . $this->field[ 'name' ] . '[' . $x . '][button_tex]' . $this->field['name_suffix'] . '" value="' . esc_attr ( $slide[ 'button_tex' ] ) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';

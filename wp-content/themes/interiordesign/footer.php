                        ...
                        <div class="row clearfix">
						 ...
						 <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									<div class="logo">
                                    	<a href="index-2.html">
                                            <img src="http://localhost/creative_theme/wp-content/uploads/2020/08/logo.png" alt="" />
                                         </a>
                                    </div>
                                    ...
                                    <ul class="social-icons">
                                        <li><a href="https://www.facebook.com/charles.dazel"><span class="fab fa-facebook-f"></span></a></li>
                                        <li><a href="https://www.facebook.com/charles.dazel"><span class="fab fa-linkedin-in"></span></a></li>
                                        <li><a href="https://www.facebook.com/charles.dazel"><span class="fab fa-twitter"></span></a></li>
                                        <li><a href="https://www.facebook.com/charles.dazel"><span class="fab fa-google-plus-g"></span></a></li>
                                    </ul>
								</div>
							</div>
							<?php endif;?>
